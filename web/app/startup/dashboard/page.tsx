...
export default function StartupDashboard() {
    ...
    const displayStats = stats.length > 0 ? stats : [
        { label: 'PROFILE VIEWS', value: '0', icon: Activity, tag: 'PORTFOLIO', color: 'text-indigo-600', bg: 'bg-indigo-50' },
        { label: 'ACTIVE MATCHES', value: '0', icon: Target, tag: 'IN PIPELINE', color: 'text-emerald-600', bg: 'bg-emerald-50' },
