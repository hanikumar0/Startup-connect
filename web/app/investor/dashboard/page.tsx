...
export default function InvestorDashboard() {
    ...
    const displayStats = stats.length > 0 ? stats : [
        { label: 'TOTAL INVESTED', value: '₹0.0Cr', icon: Briefcase, tag: 'PORTFOLIO', color: 'text-indigo-600', bg: 'bg-indigo-50' },
        { label: 'ACTIVE DEALS', value: '0', icon: Zap, tag: 'IN PIPELINE', color: 'text-emerald-600', bg: 'bg-emerald-50' },
                ...
                <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-2">
                    <div className="space-y-1">
                        ...
                        <h1 className="text-4xl font-black tracking-tight text-slate-900">
                            Welcome back, {user?.name?.split(' ')[0] || "hani"}
                        </h1>
                    </div>
                        ...
                        <section className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {(matches.length > 0 ? matches : [
                                    { label: 'Lead Investor', type: 'VC', score: 50 },
                                    { label: 'Lead Investor', type: 'VC', score: 20 },
