                ...
                <>
                        ...
                        <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-1000">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {aiMatches.slice(0, 3).map((match) => {
                                    ...
                                    return (
                                        <Card key={item.id} className="relative group border-2 border-indigo-100 shadow-lg shadow-indigo-50 hover:border-indigo-300 transition-all duration-300 overflow-hidden flex flex-col bg-white">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredProfiles.length > 0 ? filteredProfiles.map((item) => (
                            <Card key={item._id} className="group border-none shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden flex flex-col">
